...
export default class CampusGallery extends Component {
  constructor(props) {
    super(props);
    this.state = {
      images: []
  ...
  async componentDidMount() {
    var cantoFldr = await AsyncStorage.getItem("Canto-CampusPhotoGallery");
  ...
  redirectStudentGalleryDetail = (images, key) => {
    ...
    if (key != null) {
      navigation.navigate("campusGalleryDetail", {
        data: images,
        index: key
      });
    } else {
