...
export default class WeeklyGallery extends Component {
  constructor(props) {
    super(props);
    this.state = {
      images: []
  ...
  async componentDidMount() {
    var cantoFldr = await AsyncStorage.getItem("Canto-ThisWeekGallery");
  ...
  redirectStudentGalleryDetail = (images, key) => {
    ...
    if (key != null) {
      navigation.navigate("weeklyGalleryDetail", {
        data: images,
        index: key
      });
    } else {
